...
public class CreateAndEditRecipeActivityTest {
    ...
    public void save_new_recipe() throws IOException {
        ...
        onView(withId(R.id.new_directions)).perform(closeSoftKeyboard(), swipeUp(), typeText(LAUCHKUCHEN.getDirections())); // trying out whether swiping works on Firebase devices
