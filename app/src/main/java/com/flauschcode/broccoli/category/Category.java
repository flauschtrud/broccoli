...
public class Category implements Serializable {
    ...
    public static final Category SEASONAL = new Category(-4, BroccoliApplication.getContext() != null? BroccoliApplication.getContext().getString(R.string.seasonal_recipes) : "Seasonal");
