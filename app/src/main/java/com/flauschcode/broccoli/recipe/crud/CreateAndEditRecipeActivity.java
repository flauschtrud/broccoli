...
public class CreateAndEditRecipeActivity extends AppCompatActivity {
        ...
        viewModel.save()
                .thenAccept(id -> {
                    ...
                    if (recipe.getRecipeId() <= 0 && id % 5 == 0) {
                        ratingService.showRatingDialog(this);
                    }
    ...
    public static void setCustomIconTint(ImageView imageView, String imageName) {
        imageView.setImageTintList(ColorStateList.valueOf(TextUtils.isEmpty(imageName)? MaterialColors.getColor(imageView, androidx.appcompat.R.attr.colorControlNormal) : MaterialColors.getColor(imageView, com.google.android.material.R.attr.colorOnPrimarySurface)));
    }
